...
class EventAttendanceExport implements FromView, ShouldAutoSize, WithTitle, WithDrawings
{
    protected $event;
    protected $meta;

    public function __construct($event, $meta = [])
    {
        $this->event = $event;
        $this->meta = $meta;
    }
    ...
    {
        return view('exports.event_attendance_excel', [
            'event' => $this->event,
            'meta'  => $this->meta,
        ]);
    }
