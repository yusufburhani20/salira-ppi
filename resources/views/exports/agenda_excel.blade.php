...
<table>
    ...
    <tr>
        ...
        <th style="font-weight: bold; background-color: #eee; border: 2px solid #000000; width: 200px;">Model Pembelajaran</th>
        <th style="font-weight: bold; background-color: #eee; border: 2px solid #000000; width: 200px;">Media Pembelajaran</th>
    ...
    @foreach($data as $index => $item)
        <tr>
            ...
            <td style="border: 1px solid #000; vertical-align: top;">{{ $item['topic'] }}</td>
            <td style="border: 1px solid #000; vertical-align: top;">{{ $item['learning_model'] ?? '-' }}</td>
            <td style="border: 1px solid #000; vertical-align: top;">{{ $item['learning_media'] ?? '-' }}</td>
            <td style="border: 1px solid #000; vertical-align: top;">
                {{ $item['activities'] }}
