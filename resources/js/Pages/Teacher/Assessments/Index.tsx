...
export default function AssessmentIndex({ auth, assessments, classes, subjects, semesters = [], filters }: PageProps<{ 
    ...
    const updateFilter = (key: string, value: string) => {
        ...
        router.get(route('teacher.assessments.index'), newFilters, {
            preserveState: true,
            preserveScroll: true,
            replace: true
        });
